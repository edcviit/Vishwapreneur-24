...
export function Gallery() {
  return (<>
    <div>
      <h1 className="main-heading bg-gradient-to-r from-[#FF4669] to-[#CE1790] text-transparent bg-clip-text text-4xl font-bold text-center py-8 mb-3 mt-20">Gallery</h1>
    </div>
