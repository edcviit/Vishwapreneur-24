          ...
          <div className="main">
            <a href="https://www.google.com/aclk?sa=l&ai=DChcSEwibxZyL1KqEAxX9FHsHHY9SDZsYABAAGgJ0bQ&ase=2&gclid=Cj0KCQiA5rGuBhCnARIsAN11vgRbdxZN_26c2D0Fkvv4sbv7UDCWZuQ1Xx8Wv81hV93p23uebjNaDWoaAtAdEALw_wcB&sig=AOD64_0jE-Dc7sJNg1jUI2c-uBz3Jote3Q&q&nis=4&adurl&ved=2ahUKEwiEopWL1KqEAxXBZ_UHHYE7CmEQ0Qx6BAgFEAE">
              <div className="logoimg">
                <img
                  className="tokenImage"
                  src="https://res.cloudinary.com/di40y80dw/image/upload/v1708003322/Sponsors_webp/daklik83d25fpbjhcptm.webp"
                  alt="abhibus"
                />
              </div>
            </a>
          ...
          <div className="main">
            <a href="https://www.balajiwafers.com/products/">
              <div className="logoimg">
                <img
                  className="tokenImage"
                  src="https://res.cloudinary.com/di40y80dw/image/upload/v1708003322/Sponsors_webp/d9dkdoowhgdqovyoada2.webp"
                  alt="balaji"
                />
              </div>
            </a>
          ...
          <div className="main">
            <a href="https://www.budhanibros.com/">
              <div className="logoimg">
                <img
                  className="tokenImage"
                  src="https://res.cloudinary.com/di40y80dw/image/upload/v1708003322/Sponsors_webp/pvxaq7j6hwzpvcwsvrwg.webp"
                  alt="budhani"
                />
              </div>
            </a>
          ...
          <div className="main">
            <a href="https://www.imfs.co.in/">
              <div className="logoimg">
                <img
                  className="tokenImage"
                  src="https://res.cloudinary.com/di40y80dw/image/upload/v1708014297/Sponsors_webp/j209kuroisn3hd0scp9y.png"
                  alt="ed wise"
                />
              </div>
            </a>
          ...
          <div className="main">
            <a href="https://www.codingninjas.com/">
              <div className="logoimg">
                <img
                  className="tokenImage"
                  src="https://res.cloudinary.com/di40y80dw/image/upload/v1708003322/Sponsors_webp/oafgn40qgljd2ydfts2w.webp"
                  alt="ed wise"
                />
              </div>
            </a>
          ...
          <div className="main">
            <a href="https://aarnelleducation.com/study-in-usa/">
              <div className="logoimg">
                <img
                  className="tokenImage"
                  src="https://res.cloudinary.com/di40y80dw/image/upload/v1708002954/PRs_Webp/zlcgbrfmfftrvcwjah3e.webp"
                  alt="ed wise"
                />
              </div>
            </a>
          ...
          <div className="main">
            <a href="https://alpesaeducationservices.com/">
              <div className="logoimg">
                <img
                  className="tokenImage"
                  src="https://res.cloudinary.com/di40y80dw/image/upload/v1708003322/Sponsors_webp/ooz63xbjc9jfjp9j0yww.webp"
                  alt="ed wise"
                />
              </div>
            </a>
